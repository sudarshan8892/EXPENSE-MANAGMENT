...
namespace ExpinseMangament.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryId,Note,Date")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryId,Note,Date")] Transaction transaction)
        {
